...
{
    public class OwinTicketSerializer : IDataSerializer<OwinAuthenticationTicket>
    {
        ...
        public virtual byte[] Serialize(OwinAuthenticationTicket model)
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2202:Do not dispose objects multiple times", Justification = "Dispose is idempotent")]
        public virtual OwinAuthenticationTicket Deserialize(byte[] data)
        {
        ...
        public static void Write(BinaryWriter writer, OwinAuthenticationTicket model)
        {
            if (writer == null)
            {
        ...
        public static OwinAuthenticationTicket Read(BinaryReader reader)
        {
            if (reader == null)
            {
            ...
            return new OwinAuthenticationTicket(identity, properties);
        }
